...
<body>
    ...
    <div class="register-container">
        ...
        <form action="Register" method="post" onsubmit="validatePasswords(event)">
            <label for="email">Email *</label> 
            <input type="email" id="email" placeholder="Email của bạn" name="email" required>
            
            <label for="username">Tên đăng nhập *</label> 
            <input type="text" id="username" placeholder="Tên đăng nhập của bạn" name="username" required>
            
            <label for="password">Mật khẩu *</label> 
            <input type="password" id="password" placeholder="Mật khẩu của bạn" name="password" required>
