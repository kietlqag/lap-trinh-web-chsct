...
<html>
  ...
  <body>
    ...
    <section id="best-selling-items" class="position-relative padding-large ">
      <div class="container">
        <div class="section-title d-md-flex justify-content-between align-items-center mb-4">
          ...
          <a href="/PROJECT/bootstrap5/shop.html" class="btn">View All</a>
        </div>
        ...
        <div class="position-absolute top-50 start-0 ps-0 ps-xxl-5 ms-0 ms-xxl-5 swiper-prev product-slider-button-prev">
          <svg class="chevron-back-circle d-flex justify-content-center align-items-center p-2" width="10" height="10">
            <use xlink:href="#alt-arrow-left-outline"></use>
          </svg>
        </div>
          ...
          <div class="swiper-wrapper">
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="/PROJECT/bootstrap5/single-product.html">House of Sky Breath</a></h6>
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="/PROJECT/bootstrap5/single-product.html">Heartland Stars</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="/PROJECT/bootstrap5/single-product.html">Heavenly Bodies</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="/PROJECT/bootstrap5/single-product.html">His Saving Grace</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
            ...
            <div class="swiper-slide">
              <div class="card position-relative p-4 border rounded-3">
                ...
                <h6 class="mt-4 mb-0 fw-bold"><a href="/PROJECT/bootstrap5/single-product.html">My Dearest Darkest</a></h6>
                <div class="review-content d-flex">
                  <p class="my-2 me-2 fs-6 text-black-50">Lauren Asher</p>
    ...
    <script src="/PROJECT/bootstrap5/js/jquery-1.11.0.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"
      integrity="sha384-YvpcrYf0tY3lHB60NNkmXc5s9fDVZLESaAA55NDzOxhy9GkcIdslK1eN7N6jIeHz"
      crossorigin="anonymous"></script>
    <script src="https://cdn.jsdelivr.net/npm/swiper/swiper-bundle.min.js"></script>
    <script type="text/javascript" src="/PROJECT/bootstrap5/js/script.js"></script>
  </body>
</html>