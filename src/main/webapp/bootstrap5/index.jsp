		...
		<div class="container">
			<div class="row justify-content-center">
				<div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
					<div class="latest-items border rounded-3 p-4 text-center">
						<!-- Thêm text-center -->
						<div class="section-title overflow-hidden mb-5 mt-2">
							<h3 class="d-flex flex-column mb-0">Sách mới</h3>
						</div>
				...
				<div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
					<div class="best-reviewed border rounded-3 p-4 text-center">
						<!-- Thêm text-center -->
						<div class="section-title overflow-hidden mb-5 mt-2">
							<h3 class="d-flex flex-column mb-0">Sách yêu thích</h3>
						</div>
						<div class="items-lists">
							<!-- Các item ở đây -->
						</div>
				...
				<div class="col-md-6 mb-4 mb-lg-0 col-lg-3">
					<div class="on-sale border rounded-3 p-4 text-center">
						<!-- Thêm text-center -->
						<div class="section-title overflow-hidden mb-5 mt-2">
							<h3 class="d-flex flex-column mb-0">Sách giảm giá</h3>
						</div>
						<div class="items-lists">
							<!-- Các item ở đây -->
						</div>
	...
	<section id="latest-posts" class="padding-large">
		<div class="container">
			<div
				...
				<h3 class="d-flex align-items-center">Bài đăng mới nhất</h3>
				<a href="blog.jsp" class="btn">Xem tất cả</a>
			</div>
			<div class="row">
				...
				<div class="col-md-3 posts mb-4">
					<img src="images/post-item4.jpg" alt="post image"
						...
						class="fs-6 text-primary">Books</a>
					<h4 class="card-title mb-2 text-capitalize text-dark">
						<a href="single-post.jsp">Reading for Mental Health: How Books
							Can Heal and Inspire</a>
					</h4>
					<p class="mb-2">
