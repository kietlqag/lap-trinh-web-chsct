              ...
              <article class="post-item">
                <div class="post-content">
                  <div class="post-meta mt-4">
                    <span class="post-category">Feb 22, 2024 </span> - <span class="meta-date"><a href="blog.jsp">Books</a></span>
                  </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-3 posts mb-4">
            ...
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post.jsp">5 Must-Have Gadgets for
            ...
            <p class="mb-2">Dive into the world of cutting-edge technology with our latest blog post, where we highlight
              five essential gadge. <span><a class="text-decoration-underline text-black-50" href="single-post.jsp">Read More</a></span>
            </p>
          </div>
          <div class="col-md-3 posts mb-4">
            <img src="images/post-item2.jpg" alt="post image" class="img-fluid rounded-3">
            <a href="blog.jsp" class="fs-6 text-primary">Books</a>
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post.jsp">Eco-Friendly Innovations
          ...
          <div class="col-md-3 posts mb-4">
            ...
            <a href="blog.jsp" class="fs-6 text-primary">Books</a>
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post.jsp">The Future of Wearable
          ...
          <div class="col-md-3 posts mb-4">
            ...
            <a href="blog.jsp" class="fs-6 text-primary">Books</a>
            <h4 class="card-title mb-2 text-capitalize text-dark"><a href="single-post.jsp">Top Apps and Tools for
                Remote Work</a></h4>
