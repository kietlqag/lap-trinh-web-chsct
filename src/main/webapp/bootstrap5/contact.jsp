		...
		<div class="container">
			<div class="row">
				<div class="contact-info col-lg-6 pb-3">
					...
					<p class="mb-5">Liên hệ với chúng tôi qua các phương thức sau:</p>
					<div class="page-content d-flex flex-wrap">
						<div class="col-lg-6 col-sm-12">
							<div class="content-box text-dark pe-4 mb-5">
								<h5 class="fw-bold">Văn phòng Sách Chính Trị</h5>
								<div class="contact-address pt-3">
									<p>Số 01, Võ Văn Ngân, Linh Chiểu, Thủ Đức, TPHCM</p>
								</div>
								<div class="contact-number">
									<p>
										<a href="#">SĐT: 0356146325</a>
									</p>
								</div>
								<div class="email-address">
									<p>
										<a href="#">Email: kietdobi3300@gmail.com</a>
									</p>
								</div>
							</div>
						</div>
				...
				<div class="inquiry-item col-lg-6">
					<h3>Thắc mắc</h3>
					<p class="mb-5">Nếu có thắc mắc liên quan đến sản phẩm và dịch vụ, hãy gửi câu hỏi chúng tôi.</p>

					<form id="form" class="d-flex gap-3 flex-wrap">
						<div class="w-100 d-flex gap-3">
							<div class="w-50">
								<input type="text" name="name"
									placeholder="Tên của bạn *" class="form-control w-100">
							</div>
							<div class="w-50">
						...
						<div class="w-100">
							<input type="text" name="subject"
								placeholder="Tiêu đề" class="form-control w-100">
						</div>
						<div class="w-100">
