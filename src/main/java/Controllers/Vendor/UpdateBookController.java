...
public class UpdateBookController extends HttpServlet{
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    req.getRequestDispatcher("/Vendor/form-update-san-pham.jsp").forward(req, resp);
	}
	@Override
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int discountPercentage = Integer.parseInt(req.getParameter("discount_percentage"));
        ...
        service.update(id, title, author, imageUrl, discountPercentage, stock, category, price, longDescription);
